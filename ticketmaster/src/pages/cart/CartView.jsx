        ...
        <div className="flex flex-col md:flex-row justify-center items-start md:space-x-8 p-6">
            <div className="w-full md:w-3/5 mb-6 md:mb-0 ">
                ...
                <div className="grid grid-cols-12 grid-rows-3 bg-[url('./assets/ticketImg.png')] bg-cover h-60 text-center text-nowrap">
                    ...
                    <div className='col-start-1 col-end-10 row-start-2 flex flex-row max-w-lg self-center justify-center	ml-3'>
                    ...
                    <div className='col-start-1 col-end-10 row-start-3 flex flex-col max-w-lg self-center justify-center	ml-3'>
                        <p className=' font-graduate text-xl text-gray-900 dark:text-white'>
                            {event.location}
                        </p>
                        <p className='font-graduate text-xl text-gray-900 dark:text-white '>{event.date} </p>
                    </div>
                    <div className='col-start-10 col-end-13 row-start-2 self-center'>
                        <p className=' font-graduate text-5xl text-gray-900 text-[#F8C809]'
                        >${price}</p>
                    </div>
